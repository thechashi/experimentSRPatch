...
def do_binary_search():
    ...
    max_unacceptable_dimension = maximum_unacceptable_dimension_2n(device, logger, model)
    
    ut.clear_cuda(None, None)
        
    # get the maximum acceptable dimension
    max_dim = maximum_acceptable_dimension(device, logger, model, max_unacceptable_dimension)
